...
As for the 40,000 year-old Hohle Fels Flute, specific measurements of the flute — its length, column diameter, and placement of the toneholes — can yield for us the tonal scale that it would have produced when played. In fact, an actual reconstructed replica, reverse-engineered from exact measurements of the fragile original, revealed the Hohle Fels Flute to be quite comparable to a modern-day flute, producing a pentatonic scale — one of the most commonly found (and apparently ancient) musical scales, found throughout the world.

We can deduce that the flute found in the Hohle Fels cave was not a one-off. Careful inspection of the artifact shows that small lines were first carved into the flute, indicating where to "drill" the holes — so at the outset, some measurement and calculated thought of where the holes should be placed took place. The knowledge of where to place the holes to produce accurate pitch must have been the result of significant trial and error, through the development of many prototypes — perhaps even from knowledge passed down through generations. We might take this even further by suggesting that, since bone would not have been the easiest material to work with, earlier flutes may have even existed that were made from various types of wood — these items would not have survived to become part of the fossil record. How much further back in time, then, did the legacy of flute-making go? I suppose we will never know.

But just to muse on it is enough. If we travel back in time in our mind's eye, we can marvel at the sparks of ingenuity and creativity that led to world's first music — for it is those sparks that make us who we are as a species, and they should be celebrated. We can wonder about the actual music that was played on those first flutes. For what melodies were they intended? What was the effect on the listener as their songs reverberated through the ancient concert chambers of hillside caves? 
...
There, along parts of the Niger River, where it winds through low-lying countryside, the tambin vine grows in abundance. The vine itself is a woody vine, hollow throughout but with rather thick walls, not that unlike bamboo or rattan. Given that it is already hollow, tambin is well-suited to flute building: 
